...
[![Version](https://img.shields.io/badge/version-1.1.2-blue.svg)](https://github.com/Emasoft/ghe-marketplace/releases)
...
| `major` | Breaking changes, major rewrites | 0.6.0 -> 1.1.2 |

#### Independent Versioning

Each plugin has its own version:
- Tags are plugin-specific: `ghe-v0.5.4`, `marketplace-utils-v1.1.2`
...
| marketplace-utils | 1.1.2 | Portable utility tools... |
